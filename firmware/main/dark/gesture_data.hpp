...
constexpr Gesture::IndicatorBarData STYLESHEET_360_360_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr Gesture::IndicatorBarData STYLESHEET_360_360_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr Gesture::Data STYLESHEET_360_360_DARK_GESTURE_DATA = {
    .detect_period_ms = 20,
    .threshold = {
    ...
    .flags = {
        .enable_indicator_bars = {
            ...
            [static_cast<int>(Gesture::IndicatorBarType::BOTTOM)] = 0,
        },
    },
};
